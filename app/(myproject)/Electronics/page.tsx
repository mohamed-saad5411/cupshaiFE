...
export default function Electronics() {
    ...
    const slidedata = [
        { id: 1, current: true, name: 'Electronics', logo: Electronicss },
        { id: 2, current: false, name: 'Vehicle', logo: automotive },
        { id: 3, current: false, name: 'Watches', logo: watch },
        { id: 4, current: false, name: 'Jobs', logo: job },
        { id: 5, current: false, name: 'Watches', logo: watch },
        { id: 6, current: false, name: 'Clothes', logo: clothes },
        { id: 7, current: false, name: 'Furniture', logo: sofa },
        { id: 8, current: false, name: 'Clothes', logo: clothes },
        { id: 9, current: false, name: 'Watches', logo: watch },
    ]
                        ...
                        {slidedata.map((item) => (
                            <div key={item.id} className="mb-4 ps-1">
                                <Link href={`/${item.name}`} className="flex items-center gap-2">
                                    ...
                                    <p className={item.current ? 'text-black font-semibold' : 'text-gray-600'}>
                                        {item.name}
                                    </p>
                                </Link>
                            </div>
