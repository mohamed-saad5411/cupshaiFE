...
export default function Watches() {
  ...
  const slidedata: SlideItem[] = [
    { id: 1, name: 'Electronics', logo: Electronicss, current: false },
    { id: 2, name: 'Vehicle', logo: automotive, current: false },
    { id: 3, name: 'Watches', logo: watch, current: true },
    { id: 4, name: 'Jobs', logo: job, current: false },
    { id: 5, name: 'Watches', logo: watch, current: true },
    { id: 6, name: 'Clothes', logo: clothes, current: false },
    { id: 7, name: 'Furniture', logo: sofa, current: false },
    { id: 8, name: 'Clothes', logo: clothes, current: false },
    { id: 9, name: 'Watches', logo: watch, current: true }
  ]
